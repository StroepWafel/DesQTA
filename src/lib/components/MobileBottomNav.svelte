...
<nav
  ...
  {#each NAV_ITEMS as item}
    <button
      type="button"
      class="flex flex-col items-center justify-center flex-1 min-w-0 py-2 px-1 gap-0.5 min-h-[44px] transition-all duration-200 ease-in-out rounded-lg mx-0.5 {isActive(item)
