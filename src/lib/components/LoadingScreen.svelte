...
<div class={containerClasses}>
  <div class={innerClasses} transition:fade>
    <div class="relative w-48 h-32 overflow-visible">
      ...
      <svg
        class="absolute left-4 top-8 animate-cloud1"
        width="48"
        height="48"
        viewBox="0 0 24 24"
        fill="none">
      ...
      <svg
        class="absolute right-4 top-2 animate-cloud2"
        width="36"
        height="36"
        viewBox="0 0 24 24"
        fill="none">
...
<style>
  ...
  .animate-cloud1 {
    animation: cloud-move1 4s cubic-bezier(0.4, 0, 0.2, 1) infinite alternate;
  }
  .animate-cloud2 {
    animation: cloud-move2 5s cubic-bezier(0.4, 0, 0.2, 1) infinite alternate;
  }
</style>
