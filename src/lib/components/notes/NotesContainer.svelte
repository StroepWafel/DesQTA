      ...
      <div
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-4">
            ...
            <button
              class="px-4 py-2 rounded-lg bg-zinc-200 dark:bg-zinc-700 text-zinc-700 dark:text-zinc-200 transition-all duration-200 transform hover:scale-105 active:scale-95 focus:outline-hidden focus:ring-2 focus:ring-zinc-400 text-sm font-medium"
              on:click={handleCreateFolderFromTopBar}>
        ...
        {#if loading}
          <div class="flex-1 flex items-center justify-center">
            <div class="text-center">
              <div
                class="w-8 h-8 rounded-full border-4 border-zinc-300 dark:border-zinc-700 border-t-transparent animate-spin mx-auto mb-4">
              </div>
