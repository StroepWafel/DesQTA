...
<div class="inline-block relative text-left export-dropdown-container">
  <button
    ...
    <Icon src={ArrowDownTray} class="w-4 h-4 text-foreground group-hover:text-white" />
    <span class="font-medium text-sm text-foreground group-hover:text-white">
  ...
  {#if showExportMenu}
    <div
      class="absolute right-0 z-50 mt-2 w-52 rounded-2xl border shadow-2xl bg-white dark:bg-zinc-900 border-border"
      ...
      <div class="p-2">
        <button
          ...
          <div
            ...
            <Icon src={TableCells} class="w-4 h-4 text-muted-foreground group-hover:text-white" />
          </div>
        ...
        <button
          ...
          <div
            class="flex justify-center items-center w-8 h-8 rounded-lg bg-zinc-100 dark:bg-zinc-700 group-hover:bg-white/20 shrink-0">
            <Icon src={DocumentText} class="w-4 h-4 text-muted-foreground group-hover:text-white" />
          </div>
          <span class="font-medium text-sm truncate">
        ...
        <button
          ...
          <div
            class="flex justify-center items-center w-8 h-8 rounded-lg bg-zinc-100 dark:bg-zinc-700 group-hover:bg-white/20 shrink-0">
            <Icon src={CalendarDays} class="w-4 h-4 text-muted-foreground group-hover:text-white" />
          </div>
          <span class="font-medium text-sm truncate">
