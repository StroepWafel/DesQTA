...
{#if availableYears && availableYears.length > 0}
  <div class="flex flex-col gap-4 p-4 rounded-xl border backdrop-blur-xs bg-slate-100/80 dark:bg-slate-800/50 border-slate-300/50 dark:border-slate-700/50">
