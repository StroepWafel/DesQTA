...
<div class="inline-block relative text-left export-dropdown-container">
  <button
    ...
    <span class="font-semibold text-zinc-900 dark:text-white">Export</span>
  </button>
    ...
    <div
      ...
      <div class="p-3">
        ...
        <button
          ...
          <div class="flex-1">
            <div class="font-semibold text-zinc-900 dark:text-white">Export as CSV</div>
            <div class="text-sm text-zinc-500 dark:text-zinc-400">Spreadsheet format for Excel</div>
          </div>
        </button>
        ...
        <button
          ...
          <div class="flex-1">
            <div class="font-semibold text-zinc-900 dark:text-white">Export as PDF</div>
            <div class="text-sm text-zinc-500 dark:text-zinc-400">Portable document format</div>
          </div>
        </button>
        ...
        <button
          ...
          <div class="flex-1">
            <div class="font-semibold text-zinc-900 dark:text-white">Export as iCal</div>
            <div class="text-sm text-zinc-500 dark:text-zinc-400">Calendar (.ics) format</div>
          </div>
        </button>
      </div>
    </div>
