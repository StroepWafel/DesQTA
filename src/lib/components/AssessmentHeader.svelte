...
<div
  class="flex sticky top-0 z-10 gap-4 items-center px-6 py-4 bg-opacity-80 border-b backdrop-blur-xs dark:bg-slate-900 bg-slate-100 dark:border-slate-800 border-slate-200">
  <a
    href="/assessments"
